...
if ( is_user_logged_in() ) {
	...
	$custom_text = '';
	if ( penci_get_builder_mod( 'penci_header_pb_login_register_mobile_penci_tblogin_text' ) ) {
		$custom_text = '<span>' . penci_get_builder_mod( 'penci_header_pb_login_register_mobile_penci_tblogin_text' ) . '</span>';
	}
