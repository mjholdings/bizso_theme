<?php
$btn_link_target = penci_get_builder_mod( 'penci_header_pb_bookmark_link_target', '_self' );
$btn_title       = penci_get_builder_mod( 'penci_header_pb_bookmark_text_setting', false );

$classes   = [];
$classes[] = penci_get_builder_mod( 'penci_header_pb_bookmark_txt_css_class', 'default' );
