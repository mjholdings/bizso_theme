...
if ( ! function_exists( 'penci_woocommerce_style' ) ) {
	function penci_woocommerce_style() {
		...
		wp_enqueue_script( 'jquery.pjax', PENCI_SOLEDAD_URL . '/inc/woocommerce/js/jquery.pjax.js', array(), PENCI_SOLEDAD_VERSION, true );
		...
		wp_enqueue_script( 'penci-woocommerce', PENCI_SOLEDAD_URL . '/inc/woocommerce/js/penci-woocommerce.js', array(), PENCI_SOLEDAD_VERSION, true );
