...
if ( ! class_exists( 'Penci_Soledad_Gutenberg' ) ):
	class Penci_Soledad_Gutenberg {
		...
		public function enqueue_editor_assets(){
			if( is_admin() ) {
				wp_enqueue_script( 'penci-gutenberg-save-data', PENCI_SOLEDAD_URL . '/inc/gutenberg/saving-data.js', array( 'wp-blocks' ),'1.0' );
			}
		}
		*/
		...
		function register_block() {
			if( is_admin() ){
				wp_enqueue_style( 'penci-gutenberg', PENCI_SOLEDAD_URL . '/inc/gutenberg/style.css', array( 'wp-edit-blocks' ), PENCI_SOLEDAD_VERSION );
			}
		}
