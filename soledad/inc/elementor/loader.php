...
class Loader {
	...
	public function register_frontend_scripts() {
		...
		wp_register_script( 'jquery.plugin', PENCI_SOLEDAD_URL . '/js/jquery.plugin.min.js', array( 'jquery' ), '2.0.2', true );
		wp_register_script( 'countdown', PENCI_SOLEDAD_URL . '/js/jquery.countdown.min.js', array( 'jquery' ), '2.0.2', true );
		wp_register_script( 'waypoints', PENCI_SOLEDAD_URL . '/js/waypoints.min.js', array( 'jquery' ), '2.0.3', true );
		wp_register_script( 'jquery-counterup', PENCI_SOLEDAD_URL . '/js/jquery.counterup.min.js', array(
			'jquery',
			'waypoints'
		), '1.0', true );
		wp_register_script( 'penci-button-popup', PENCI_SOLEDAD_URL . '/inc/elementor/assets/js/penci-button-popup.js', array( 'jquery' ), '1.0', true );
	}
