...
if (!isset($layout_this) || empty($layout_this)) : $layout_this = 'standard';
endif;
$class_layout = '';
if ($layout_this == 'classic') : $class_layout = ' classic-layout';
endif;
$two_sidebar_class = '';
if ('two-sidebar' == $sidebar_position) : $two_sidebar_class = ' two-sidebar';
endif;
			...
			<div class="pc-title-bar-sorter">
				...
				<form action="<?php echo home_url($wp->request); ?>" method="get">
					<select name="pc_archive_sort" id="pc_archive_sort">
						<option <?php selected('desc', $current_sort); ?> value="desc"><?php _e('Newest', 'soledad'); ?></option>
						<option <?php selected('asc', $current_sort); ?> value="asc"><?php _e('Oldest', 'soledad'); ?></option>
					</select>
				</form>
			</div>
		<?php endif; ?>
...
<div class="container<?php echo esc_attr($class_layout);
	...
	<?php if (penci_get_setting('penci_sidebar_archive')) : ?>
		<?php get_sidebar(); ?>
		<?php if (get_theme_mod('penci_two_sidebar_archive')) : get_sidebar('left');
		endif; ?>
	<?php endif; ?>
</div>
<?php get_footer(); ?>